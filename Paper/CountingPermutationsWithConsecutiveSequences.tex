...
and wrote two general-purpose algorithms---one building upon the other---to quickly
...
I am quite certain that combinatorial mathematicians already know everything that is needed
for these correctness proofs, but again, I was not able to find the things I needed online.
That is the reason why I wrote this paper. Any feedback, particularly regarding references to
...
for $n$ equals $(\lfloor\frac{n}{2}\rfloor + 1 )!$, and therefore, the algorithm affords no real advantage over
