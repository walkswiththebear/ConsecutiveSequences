...
greater than or equal to $u$ and then subtract that from $n!$. Now the optimization is applicable.

\section{Permutations with Consecutive Sequences}
The algorithm we have discussed so far deal with the number of permutations having certain configurations
...
length greater than or equal to $k$. This is the application of Theorem
...
look at MCS-specification by lengths and count that specify a zero count for lengths greater than
